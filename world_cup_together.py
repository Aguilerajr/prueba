...
semi_final1 = sfinal(2)
team1 = Teams("Quatar", 0)
team2 = Teams("Netherlands", 0)
team3 = Teams("Usa", 0)
team4 = Teams("spain", 0)
semi_final1.add_teams(team1)
semi_final1.add_teams(team2)
semi_final1.add_teams2(team3)
semi_final1.add_teams2(team4)
print(f"The match one is {semi_final1.match1[0].country} vs {semi_final1.match1[1].country} ")
team1.scores(team1)
team2.scores(team2)
print(f"The match two is {semi_final1.match2[0].country} vs {semi_final1.match2[1].country} ")
team3.scores(team3)
team4.scores(team4)
semi_final1.winners(semi_final1.match1)
semi_final1.winners(semi_final1.match2)
final1 = final(10)
final1.addfinalist(semi_final1.match1,semi_final1.match2)
